/*
  ...
  GitHub Actions CLOUDFLARE_API_TOKEN secret for a Cache-Purge-only token so a
  CI leak can't touch DNS. See .claude/CLAUDE.md.
*/
...
for (const dir of [".claude", ".agents", ".research", ".design-sync"]) {
  try {
