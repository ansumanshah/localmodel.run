...
const TIER_CAP = { e: 80, m: 100, h: 120 } as const
const PER_MODEL_CAP = 4
const PER_DEVICE_CAP = 12

export function buildGamePool(): GameRound[] {
  const candidates: (GameRound & { _h: number; _mid: string; _did: string })[] = []
